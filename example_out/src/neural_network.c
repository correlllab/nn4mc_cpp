...
void buildLayers(){
        ...
        conv2d_1 = buildConv2D(&conv2d_1_W[0], conv2d_1_b, 3, 3, 0, 1, 1, 28, 28, 1);

        conv2d_2 = malloc(sizeof (struct Conv2D)); 
        conv2d_2 = buildConv2D(&conv2d_2_W[0], conv2d_2_b, 3, 3, 0, 1, 1, 5, 5, 5);
        ...
        max_pooling2d_1 = buildMaxPooling1D(, , 5,  5);
